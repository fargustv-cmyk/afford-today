...
const WELCOME = [
  'привет!',
  '',
  'afford.today помогает отличить реальные ограничения от привычного «я не могу себе это разрешить».',
  '',
  'добавь покупку или действие для себя, проверь три опоры и прими своё решение — без очков, гринда и домашних заданий.',
  '',
  'жми кнопку ниже.'
].join('\n');
