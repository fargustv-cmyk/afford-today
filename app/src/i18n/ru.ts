...
export const ru = {
  ...
  paywall_reason_theme: 'тёмные/тёплые темы — часть Pro.',
  ...
  paywall_packs_desc: '«после выгорания», «первая зарплата», «вечерний ритуал», «после расставания» — курируем под жизненный момент.',
  paywall_freedom_title: 'карта свободы Pro',
  paywall_freedom_desc: 'тренды по неделям и месяцам, разбивка «позволение vs труд» — видно, как ты растёшь.',
