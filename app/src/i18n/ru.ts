...
export const ru = {
  ...
  paywall_packs_title: 'тематические библиотеки шагов',
  paywall_packs_desc: '«после выгорания», «первая зарплата», «вечерний ритуал», «после расставания» — пакеты под конкретный момент жизни.',
  ...
  paywall_themes_title: 'темы оформления',
  paywall_themes_desc: 'ночь, лес, бумага — приложение под твоё настроение.',
  paywall_cta: 'купить Pro · 100 ⭐',
  paywall_foot: 'разовая покупка через Telegram Stars. без подписки.',
