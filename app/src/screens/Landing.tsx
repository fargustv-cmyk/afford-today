  ...
  return (
    <main className="landing">
      ...
      <section className="landing-hero" id="top">
        ...
        <p>
          afford.today помогает проверить деньги или время, услышать себя и принять решение
      ...
      <section className="landing-demo" aria-label="как это работает">
        <article>
          <span>1</span>
          <h2>Добавь желание</h2>
          <p>Покупку, отдых или действие для себя.</p>
        </article>
        <article>
          <span>2</span>
          <h2>Проверь опоры</h2>
          <p>Деньги или время выдерживают? Желание всё ещё твоё?</p>
        </article>
        <article>
          <span>3</span>
          <h2>Реши сам</h2>
      ...
      <section className="landing-promise">
        ...
        <strong>Если реальные ограничения не мешают — право выбрать уже у тебя.</strong>
      </section>
